...
from middlewares import MenuInterruptMiddleware

from handlers import common, sell, buy, jobs, payment, admin, my_listings
...
async def main():
    ...
    # Har bir matnli xabar kelishidan oldin ishlaydi:
    # foydalanuvchi jarayon ichida bo'lsa-yu, menyu tugmasini bossa - jarayon to'xtatiladi
